...
<style>
    :root { 
        ...
        --border: #334155; --primary: #3b82f6; --success: #10b981; --danger: #ef4444; 
    }
    ...
    .metric-label { display: flex; justify-content: space-between; font-size: 0.9rem; margin-bottom: 6px; font-weight: 500; }
    .mono { font-family: 'JetBrains Mono', 'Consolas', monospace; color: var(--primary); }
    .bar-bg { background: #334155; height: 6px; border-radius: 3px; overflow: hidden; }
    ...
    .interactive-text { cursor: help; border-bottom: 1px dotted var(--muted); position: relative; }
